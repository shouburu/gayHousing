...
<head>
    ...
    <title>
        LGBT Roomate Finder Registration
    </title>
    <!--     Fonts and icons     -->
...
<body class="index-page ">
    ...
    <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="/presentation.html">LGBT Roomate Finder</a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)" onclick="scrollToDownload()">
                            <i class="material-icons">open_in_browser</i> Sign In
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0)" onclick="scrollToDownload()">
                            <i class="material-icons">leak_add</i> Register
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="page-header header-filter purple-filter" data-parallax="true" style="background-image: url('assets/img/kit/bg2.jpg'); height: 40vh">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="brand">
                        <h1>LGBT Roomate Finder</h1>
                        <h3>Register <ins></ins> under 2 minutes.</h3>
                    </div>
                </div>
            </div>
        </div>
 ...
 -->                <!--                 inputs -->
                <div id="inputs">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <span class="bmd-help">You will use this to log in.</span>
                            </div>
                        </div>
                       <div class="col-lg-3 col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="form-group">
                                <label for="email" class="bmd-label-floating">Repeat Password</label>
                                <input type="email" class="form-control" id="email">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="range" class="slider slider-danger"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                           ...
                           <ul class="nav nav-pills nav-pills-icons nav-pills-primary" role="tablist">
                            ...
                            -->
                                <li class="nav-item">
                                    <a class="nav-link" href="#dashboard-1" role="tab">
                                        <!-- <i class="material-icons">dashboard</i> -->
                                        <img src="assets/img/L.svg.png" style="height: 40px;" /><br> L
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="#schedule-1" role="tab">
                                         <img src="assets/img/G.svg.png" style="height: 40px;" /><br> G
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tasks-1" role="tab">
                                        <img src="assets/img/B.svg.png" style="height: 40px;" /><br> B
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tasks-1" role="tab">
                                        <img src="assets/img/T.svg.png" style="height: 40px;" /><br> T
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h5>What kinds of roomates are you looking for?</h5>
                            </div>
                           <ul class="nav nav-pills nav-pills-icons nav-pills-primary" role="tablist">
                                <!--
                                color-classes: "nav-pills-primary", "nav-pills-info", "nav-pills-success", "nav-pills-warning","nav-pills-danger"
                            -->
                                ...
                                <li class="nav-item lgbtSelection">
                                    <a class="nav-link" href="#dashboard-1" role="tab" data-toggle="pill">
                                        <!-- <i class="material-icons">dashboard</i> -->
                                        <img src="assets/img/L.svg.png" style="height: 40px;" /><br> L
                                    </a>
                                </li>
                                <li class="nav-item lgbtSelection">
                                    <a class="nav-link active" href="#schedule-1" role="tab" data-toggle="pill">
                                         <img src="assets/img/G.svg.png" style="height: 40px;" /><br> G
                                    </a>
                                </li>
                                <li class="nav-item lgbtSelection">
                                    <a class="nav-link" href="#tasks-1" role="tab" data-toggle="pill">
                                        <img src="assets/img/B.svg.png" style="height: 40px;" /><br> B
                                    </a>
                                </li>
                                <li class="nav-item lgbtSelection">
                                    ...
                                    <li class="dropdown nav-item">
                                        <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                                            <div class="profile-photo-small">
                                                <img src="assets/img/kit/faces/avatar.jpg" alt="Circle Image" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <h6 class="dropdown-header">Dropdown header</h6>
            ...
            <div class="container tim-container">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <h4>Rounded Image</h4>
                            <img src="assets/img/kit/faces/avatar.jpg" alt="Rounded Image" class="rounded img-fluid">
                        </div>
                        ...
                        <div class="col-sm-2 ml-auto">
                            ...
                            <img src="assets/img/kit/faces/avatar.jpg" alt="Raised Image" class="img-raised rounded img-fluid">
                        </div>
                        <div class="col-sm-2 ml-auto">
                            <h4>Circle Raised</h4>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="assets/img/kit/bg2.jpg" alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/img/kit/bg3.jpg" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/img/kit/bg.jpg" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                                <i class="material-icons">location_on</i> Yellowstone National Park, United States
                                            </h4>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="examples/landing-page.html" target="_blank">
                            <img src="assets/img/kit/free/landing.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
                            <button class="btn  btn-link btn-primary btn-lg">View Landing Page</button>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="examples/profile-page.html" target="_blank">
                            <img src="assets/img/kit/free/profile.jpg" alt="Rounded Image" class="img-raised rounded img-fluid">
...
$('li.lgbtSelection').click(function() {
